...
const FIRST_PAGE = 1;
const MAX_UNCOLLAPSED_PAGES_COUNT = 5;
...
export const PaginationComponent: React.FC<PaginationProps> = ({ currentPage, totalPages, onPageChange }) => {
    ...
    const shouldCollapse = totalPages > MAX_UNCOLLAPSED_PAGES_COUNT;
    ...
    return (
        <div className={styles.paginationFlex}>
            <button
                className={`${styles.paginationButton} ${currentPage === FIRST_PAGE ? styles.disabled : ''}`}
